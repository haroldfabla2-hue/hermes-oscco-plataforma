  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-brand-blue text-white py-20 relative overflow-hidden">
        <FadeIn direction="up" duration={0.8} className="container mx-auto px-4 relative z-10">
        ...
        <div className="container mx-auto px-4">
          <StaggerContainer className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {works.length === 0 ? (
              ...
              works.map((work, idx) => (
                <FadeIn key={work.id} direction="up" delay={idx * 0.08} duration={0.5}>
                  <Link href={`/obras/${work.slug}`} className="group">
                    <HoverCard yOffset={-8} scale={1.03}>
                      <Card className="overflow-hidden border-none shadow-lg transition-all duration-300 rounded-3xl h-full flex flex-col">
